...
test3="deduplicated on "+datestr(today())
...
lastrecord
 ...
 //message "Merged and archived! Use CMD-5 to clear these records from Deduplicator and start again!"
    ...
    selectwithin «SpareText1» notcontains "Dedup"
...
noshow
        global CH_merge_list, ML_merge_list, on_both, merge_counter,
            ...
            */
            ...
            ///make it so it can be excluded from future deduplications
            SpareText1="Deduplicated on "+datestr(today())

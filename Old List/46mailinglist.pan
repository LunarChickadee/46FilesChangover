...
window  waswindow
    if info("windows") notcontains "ZipCodeList"
        openfile "ZipCodeList"
        makesecret
    endif
window waswindow
...
;downrecord
;window "46 mailing list:customer history"
;else
;downrecord
;endif
if info("formname")="addresschecker"
    downrecord
    window "46orders:seedsinput"
    downrecord
    window "46 mailing list:addresschecker"
endif
defaultcase
...
if info("files") contains "46orders"
goto continue
else
opensecret "46orders"
endif
...
St=grabdata("46 mailing list", St)
Zip=grabdata("46 mailing list", Zip)
SpareText2=grabdata("46 mailing list", SpareText2)
...
local address
UpRecord
arraylinebuild address,¬,"46 mailing list", City+¬+St+¬+str(Zip)+¬+str(adc)+¶
DownRecord
...
case searchcust≠""
liveclairvoyance searchcust, findcust, ¶, "CustomerList","46 mailing list", str(«C#»), "beginswith", str(«C#»), 10, 0, ""
case searchname≠""
liveclairvoyance searchname, findname, ¶, "NameList","46 mailing list", Con, "match", str(«C#»)+": "+Con, 10, 0, ""
endcase
